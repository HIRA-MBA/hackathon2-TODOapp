...
def upgrade() -> None:
    ...
    op.create_table('chatkit_session',
    ...
    op.create_index(op.f('ix_chatkit_session_token'), 'chatkit_session', ['token'], unique=True)
    op.create_index(op.f('ix_chatkit_session_user_id'), 'chatkit_session', ['user_id'], unique=False)
